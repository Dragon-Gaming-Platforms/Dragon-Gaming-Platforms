- **[canvas-tetris](github.com/trilarion/opensourcegames/entries/canvas-tetris.md)** (JavaScript, MIT, mature, inactive since 2018)
- **[Card Stories](github.com/trilarion/opensourcegames/entries/card_stories.md)** (JavaScript, Python, AGPL-3.0, beta, inactive since 2012)
- **[Castle of the Winds in Elm](github.com/trilarion/opensourcegames/entries/castle_of_the_winds_in_elm.md)** (Elm, JavaScript, MIT, beta)
- **[Castle of the Winds](github.com/trilarion/opensourcegames/entries/castle_of_the_winds.md)** (JavaScript, MIT, beta, inactive since 2016)
- **[Catch The Cat](github.com/trilarion/opensourcegames/entries/catch_the_cat.md)** (TypeScript, JavaScript, MIT, mature)
- **[Cattle Bity](github.com/trilarion/opensourcegames/entries/cattle_bity.md)** (TypeScript, MIT, mature)
- **[CaveExpress](github.com/trilarion/opensourcegames/entries/caveexpress.md)** (C, JavaScript, GPL-3.0, mature)
- **[cc94](github.com/trilarion/opensourcegames/entries/cc94.md)** (C++, Python, AGPL-3.0, beta)
- **[Chess3D](github.com/trilarion/opensourcegames/entries/chess3d.md)** (JavaScript, Python, GPL-3.0, mature, inactive since 2016)
