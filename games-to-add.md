- **[canvas-tetris](https://github.com/trilarion/opensourcegames/entries/canvas-tetris.md)** (JavaScript, MIT, mature, inactive since 2018)
- **[Card Stories](https://github.com/trilarion/opensourcegames/entries/card_stories.md)** (JavaScript, Python, AGPL-3.0, beta, inactive since 2012)
- **[Castle of the Winds in Elm](https://github.com/trilarion/opensourcegames/entries/castle_of_the_winds_in_elm.md)** (Elm, JavaScript, MIT, beta)
- **[Castle of the Winds](https://github.com/trilarion/opensourcegames/entries/castle_of_the_winds.md)** (JavaScript, MIT, beta, inactive since 2016)
- **[Catch The Cat](https://github.com/trilarion/opensourcegames/entries/catch_the_cat.md)** (TypeScript, JavaScript, MIT, mature)
- **[Cattle Bity](https://github.com/trilarion/opensourcegames/entries/cattle_bity.md)** (TypeScript, MIT, mature)
- **[CaveExpress](https://github.com/trilarion/opensourcegames/entries/caveexpress.md)** (C, JavaScript, GPL-3.0, mature)
- **[cc94](https://github.com/trilarion/opensourcegames/entries/cc94.md)** (C++, Python, AGPL-3.0, beta)
- **[Chess3D](https://github.com/trilarion/opensourcegames/entries/chess3d.md)** (JavaScript, Python, GPL-3.0, mature, inactive since 2016)
